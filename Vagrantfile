...
Vagrant.configure("2") do |config|
  ...
  config.vm.hostname = "tdreamcheftraining-starter"
  ...
  #   chef.chef_server_url = "https://api.opscode.com/organizations/tdreamcheftraining"
  #   chef.validation_client_name = "tdreamcheftraining-validator"
  #   chef.validation_key_path = ".chef/tdreamcheftraining-validator.pem"
  # end
end
